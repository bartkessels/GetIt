...
TEST_CASE("JsonHighlighterRules - integerRule")
{
    SECTION("Allows - (minus) sign in front of number")
    {
        ...
        std::regex regex(JsonHighlighterRules::integerRule->regex);
...
TEST_CASE("JsonHighlighterRules - stringRule")
{
    SECTION("Allows string within double quotes")
    {
        ...
        std::regex regex(JsonHighlighterRules::stringRule->regex);
    ...
    {
        // Arrange
        const auto& inputValue = "\"This is my string with the number 5\"";
        std::regex regex(JsonHighlighterRules::stringRule->regex);
