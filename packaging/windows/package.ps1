...
Invoke-Expression "cmake . -G Ninja -DPackaging=true -DCMAKE_TOOLCHAIN_FILE=C:\vcpkg\scripts\buildsystems\vcpkg.cmake -DVCPKG_TARGET_TRIPLET=x64-windows-static -DBoost_INCLUDE_DIR=C:\vcpkg\installed\x64-windows-static\include"
