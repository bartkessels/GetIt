...
Invoke-Expression "cmake . -G Ninja -DCMAKE_TOOLCHAIN_FILE=C:\vcpkg\scripts\buildsystems\vcpkg.cmake -DVCPKG_TARGET_TRIPLET=x86-windows-static -DBoost_INCLUDE_DIR=C:\vcpkg\x64-windows-static\include"
