...
static void getit_window_settings_cb_btn_save (GtkWidget *caller,
                                               gpointer   user_data);
static void getit_window_settings_cb_btn_cancel (GtkWidget *caller,
                                                 gpointer   user_data);
...
getit_window_settings_new (GtkWindow *parent_window)
{
    ...
    window_settings = g_object_new (GETIT_TYPE_WINDOW_SETTINGS,
                                    ...
                                    "default-width", WINDOW_SETTINGS_WIDTH,
                                    "default-height", WINDOW_SETTINGS_HEIGHT,
                                    NULL);
...
getit_window_settings_class_init (GetitWindowSettingsClass *klass)
{
    ...
    gtk_widget_class_bind_template_child (widget_class, GetitWindowSettings, btn_cancel);
}
...
getit_window_settings_init (GetitWindowSettings *self)
{
    ...
    g_assert (GETIT_IS_WINDOW_SETTINGS (self));
    ...
    g_signal_connect (self->btn_cancel, "clicked",
                      G_CALLBACK (getit_window_settings_cb_btn_cancel), self);
...
static void
getit_window_settings_cb_btn_cancel (GtkWidget *caller,
                                     gpointer   user_data)
{
    g_assert (GTK_IS_BUTTON (caller));
    g_assert (GETIT_IS_WINDOW_SETTINGS (user_data));
